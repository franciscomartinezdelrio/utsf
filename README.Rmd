...
or you can install the **stable** version from [CRAN](https://cran.r-project.org/):
...
If you are interested in this package you can read its [vignette](https://cran.r-project.org/web/packages/utsf/vignettes/utsf.html) where all its important features are described.
