...
my_knn_model <- function(X, y, param) { structure(list(X = X, y = y), class = "my_knn") }
...
The `param` parameter receives a named list with the names and values of the arguments of the model to be adjusted.
...
The additional arguments specified in the `create_model()` function are passed in a list as argument to the `param` parameter of the function that trains the model (`my_knn_model()`).
